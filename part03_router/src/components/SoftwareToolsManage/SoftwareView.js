    ...
    axios
      ...
      .then((response) => {
        try {
          ...
          $("#upload_img").prepend(
            '<img id=" src="' + data.swt_big_imgpath + '"/>'
          );
          $("#upload_img2").prepend(
    ...
    return axios
      ...
      .then((res) => {
        if (type == "file") {
          ...
          $("#uploadimg").remove();
          $("#upload_img").prepend(
            '<img id="uploadimg" src="/image/' + this.state.fileName + '"/>'
          );
          $("#upload_img").prepend(
          ...
          $("#uploadimg2").remove();
          $("#upload_img2").prepend(
            '<img id="uploadimg2" src="/image/' + this.state.fileName2 + '"/>'
          );
          $("#upload_img2").prepend(
